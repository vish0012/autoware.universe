...
: Node("voxel_grid_based_euclidean_cluster_node", options)
{
  ...
  const int min_points_number_per_voxel = this->declare_parameter<int>("min_points_number_per_voxel");
  ...
  const int max_voxel_cluster_for_output = this->declare_parameter<int>("max_voxel_cluster_for_output");
