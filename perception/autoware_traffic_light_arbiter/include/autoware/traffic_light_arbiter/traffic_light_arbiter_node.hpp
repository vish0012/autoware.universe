...
#ifndef AUTOWARE__TRAFFIC_LIGHT_ARBITER__TRAFFIC_LIGHT_ARBITER_NODE_HPP_
#define AUTOWARE__TRAFFIC_LIGHT_ARBITER__TRAFFIC_LIGHT_ARBITER_NODE_HPP_
...
class TrafficLightArbiterNode : public autoware::agnocast_wrapper::Node
{
public:
  explicit TrafficLightArbiterNode(const rclcpp::NodeOptions & options);
...
private:
  ...
  std::unique_ptr<TrafficLightArbiter> core_;
};
}  // namespace autoware::traffic_light

#endif  // AUTOWARE__TRAFFIC_LIGHT_ARBITER__TRAFFIC_LIGHT_ARBITER_NODE_HPP_
