...
{
  using DETECTION_COV_IDX = autoware_utils::xyzrpy_covariance_index::XYZRPY_COV_IDX;
  using RADAR_COV_IDX = autoware_utils::xyz_upper_covariance_index::XYZ_UPPER_COV_IDX;
